...
class BinaryParser(GPParser):
    ...
    def parse_bytes(self, file_content: bytes) -> Song:
        ...
        # Note: guitarpro.parse might strictly require a filename for extension detection?
                ...
                for gp_voice in gp_measure.voices:
                    ...
                    for gp_beat in gp_voice.beats:
                        ...
                        for gp_note in gp_beat.notes:
                            ...
                            elif gp_note.type.name == 'tie': # Logic might be different in PyGuitarPro
                            ...
                            if gp_note.effect.isBend:
                                # Process bend points
                                effects.append(NoteEffect(type=EffectType.BEND)) # Simplify for now
